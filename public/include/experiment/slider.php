    ...
    <div class="contentContainer">
        ...
        <div class="sliderTableContainer">
            <form method="post" action= <?php echo "index.php?round=" . $_GET['round'] . "&mode=2&expid=$experimentID&pid=$participantID"?> >
                ...
                <input type="submit" class="formButton" id="continueButton" name="Continue" value="Continue">
            </form>
...
<script>
    ...
    var countdownTimer = setInterval(function() {
        if (time > 0) {
            ...
            let newURL = "<?php echo "index.php?round=" . $_GET['round'] . "&mode=2&expid=$experimentID&pid=$participantID&score="?>" + totalScore;

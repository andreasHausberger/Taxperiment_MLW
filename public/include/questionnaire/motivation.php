...
<form method="post">
    <div class="item">
        <p class="questionText"> <b> Paying tax is the right thing to do. </b>
    ...
    <div class="item">
        <p class="questionText"> <b> Paying my tax ultimately advantages everyone. </b>
        </p>
        <div class="radioDisplayHorizontal">
    ...
    <div class="item">
        <p class="questionText"> <b> I think of tax paying as helping the government do worthwhile things. </b>
        </p>
        <div class="radioDisplayHorizontal">
    ...
    <div class="item">
        <p class="questionText"> <b> I like to talk with friends about the gaps and loopholes in the tax system. </b>
        </p>
        <div class="radioDisplayHorizontal">
    ...
    <div class="item">
        <p class="questionText"> <b> I enjoy exploring the gaps and barriers of tax law. </b>
        </p>
        <div class="radioDisplayHorizontal">
    ...
    <div class="item">
        <p class="questionText"> <b> I find pleasure in finding a way to minimize my tax payments. </b>
        </p>
        <div class="radioDisplayHorizontal">

...
$fineContent = "Missing tax + <br> $fineRate x evaded amount";
...
$mouselabBoxArray = array(
    ...
    2 => array(
        "label" => "$incomeLabel^$taxLabel`$auditLabel^$fineLabel`$evRiskyLabel^$sureGainLabel",
        "content" => "$incomeContent^$taxContent`$auditContent^$fineContent`$evRiskyContent^$sureGainContent"),
    3 => array(

...
function ShowCont(fieldname, objEvent, isCalledFromCustomField = false, customBoxValue = null)
{
...
function HideCont(fieldname,objEvent, isCalledFromCustomField)
{
	if (!loaded) {return;} // do not open boxes when page is loading
